class WebGLCanvasView {
    ...
    constructor(canvas) {
        ...
        const originalContext = this._renderer.getContext();
        originalContext.imageSmoothingEnabled = false;

        this._context = this._renderer;
        this._context.setSize(this._canvas.clientWidth, this._canvas.clientHeight, false);
        this._context.setClearColor(0x000000, 1);
    ...
    setRenderer(renderer) {
        ...
        this._renderer.initializeScene(this._context, this._canvas.width, this._canvas.height, this._scale);
    }
    ...
    _render(context) {
        this._context.setSize(this._canvas.clientWidth, this._canvas.clientHeight, false);
        this._context.setClearColor(0xFFFF00, 1);
